...
/**
 * Tests for {@link InfluxDBGaugeWriter}.
 *
 * @author Mateusz Klimaszewski
 */
public class InfluxDBGaugeWriterTests {

	private InfluxDB influxDB = mock(InfluxDB.class);
	private InfluxDBGaugeWriter influxDBMetricWriter;

	@Test
	public void builderNonDefaultOptions() {
		this.influxDBMetricWriter = new InfluxDBGaugeWriter.Builder(this.influxDB)
